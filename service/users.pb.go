...
type User struct {
	...
	LastAnem      string                 `protobuf:"bytes,3,opt,name=last_anem,json=lastAnem,proto3" json:"last_anem,omitempty"`
...
func (x *User) GetLastAnem() string {
	if x != nil {
		return x.LastAnem
	}
	return ""
...
var file_users_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x73, 0x74, 0x5f, 0x61, 0x6e, 0x65, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x6c, 0x61, 0x73, 0x74, 0x41, 0x6e, 0x65, 0x6d, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67, 0x65,
